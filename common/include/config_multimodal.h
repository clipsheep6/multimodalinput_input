...
#define ENABLE_CLIENT_RECONNECT     // Enable client disconnection and reconnection
#define DEF_SEAT_ID "seat0"         // Default libinput seat
    ...
    #define DEF_UDS_PATH            "/root/projects/run_root/server2139"  // Default socket listening file pathname
    ...
    #define DEF_UDS_PATH "/data/mmi/server2139"
