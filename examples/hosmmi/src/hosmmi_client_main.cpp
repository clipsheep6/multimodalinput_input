...
public:
    ...
    {
        MMI_LOG_T("AppKeyEventHandle::Onkey");
        return true;
    }
};
...
public:
    ...
    {
        MMI_LOG_T("AppTouchEventHandle::OnTouch");
        return true;
    }
};
...
public:
    ...
    ~MMIClientDemo()
    {
        MMI_LOG_I("in %s enter.\n", __func__);
        UnregisterStandardizedEventHandle();
        MMI_LOG_I("in %s leave.\n", __func__);
    }

    void RegisterStandardizedEventHandle()
    {
        MMI_LOG_I("MMIClientDemo RegisterStandardizedEventHandle enter.");

        MMI_LOG_T("Register key event.");
        ...
        MMI_LOG_T("Register touch event.");
        ...
        MMI_LOG_T("Register Common event.");
        ...
        MMI_LOG_T("Register Media event.");
        ...
        MMI_LOG_T("Register System event.");
        ...
        MMI_LOG_T("Register Telephone event.");
    ...
    {
        MMI_LOG_I("MMIClientDemo::UnregisterStandardizedEventHandle enter.");
        for (auto it = handerMap_.begin(); it != handerMap_.end();) {
            MMI_LOG_T("UnregisterStandardizedEventHandle %{public}s", it->first.c_str());
...
void RunClient()
{
    ...
    MMI_LOG_T("UnRegisterStandardizedEventHandle begin....");
    client.UnregisterStandardizedEventHandle();
    MMI_LOG_T("UnRegisterStandardizedEventHandle end, wait 3000ms exit.");
}

void ClientStopHandler(int signalNo)
{
    MMI_LOG_I("client will exit! %d\n", signalNo);
    g_clientExit = true;
}
}
