...
public:
    ...
    void MouseBtnStateCounts(uint32_t btnCode, enum BUTTON_STATE btnState);

private:
    int32_t LibinputChangeToPointer(uint32_t keyValue);
    void ChangeMouseState(enum BUTTON_STATE btnState, int32_t& btnStateCount);
