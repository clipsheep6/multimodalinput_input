...
void MouseDeviceState::MouseBtnStateCounts(uint32_t btnCode, enum BUTTON_STATE btnState)
{
    std::lock_guard<std::mutex> lock(mu_);
...
int32_t MouseDeviceState::LibinputChangeToPointer(uint32_t keyValue)
{
...
void MouseDeviceState::ChangeMouseState(enum BUTTON_STATE btnState, int32_t &btnStateCount)
{
