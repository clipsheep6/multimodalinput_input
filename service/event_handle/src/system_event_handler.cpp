...
{
    mapFuns_ = {
        {ID_MSG_ON_SCREEN_SHOT, std::bind(&SystemEventHandler::OnScreenShot, this)},
        {ID_MSG_ON_SCREEN_SPLIT, std::bind(&SystemEventHandler::OnScreenSplit, this)},
        {ID_MSG_ON_START_SCREEN_RECORD, std::bind(&SystemEventHandler::OnStopScreenRecord, this)},
        {ID_MSG_ON_STOP_SCREEN_RECORD, std::bind(&SystemEventHandler::OnStartScreenRecord, this)},
        {ID_MSG_ON_GOTO_DESKTOP, std::bind(&SystemEventHandler::OnGotoDesktop, this)},
        {ID_MSG_ON_RECENT, std::bind(&SystemEventHandler::OnRecent, this)},
        {ID_MSG_ON_SHOW_NOTIFICATION, std::bind(&SystemEventHandler::OnShowNotification, this)},
        {ID_MSG_ON_LOCK_SCREEN, std::bind(&SystemEventHandler::OnLockScreen, this)},
        {ID_MSG_ON_SEARCH, std::bind(&SystemEventHandler::OnSearch, this)},
        {ID_MSG_ON_CLOSEPAGE, std::bind(&SystemEventHandler::OnClosePage, this)},
        {ID_MSG_ON_LAUNCH_VOICE_ASSISTANT, std::bind(&SystemEventHandler::OnLaunchVoiceAssistant, this)},
        {ID_MSG_ON_MUTE, std::bind(&SystemEventHandler::OnMute, this)},
        {ID_MSG_ON_BACK, std::bind(&SystemEventHandler::OnBack, this)},
    };
}
...
int32_t OHOS::MMI::SystemEventHandler::OnSystemEventHandler(int16_t idMsg)
{
