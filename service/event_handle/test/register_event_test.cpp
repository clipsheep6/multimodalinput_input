...
public:
    ...
    bool OnGetRepeatKetStateUnitTest(const int32_t keyCode, ID_MSG& msgId)
    {
        return OnGetRepeatKetState(keyCode, msgId);
    }

    int32_t OnEventKeyJudgeUnitTest(const int32_t keyCode, ID_MSG& msgId)
    {
        EventKeyboard key = {};
        key.key = keyCode;
