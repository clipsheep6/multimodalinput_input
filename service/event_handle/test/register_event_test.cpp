...
public:
    ...
    bool OnGetRepeatKetStateUnitTest(const int32_t keyCode, int32_t &msgId)
    {
        return OnGetRepeatKetState(keyCode, msgId);
    }

    int32_t OnEventKeyJudgeUnitTest(const int32_t keyCode, int32_t &msgId)
    {
        EventKeyboard key = {};
        key.key = keyCode;
...
HWTEST_F(RegisterEventTest, OnEventPointAxis_001, TestSize.Level1)
{
    ...
    int32_t msg = MmiMessageId::INVALID_MSG_ID;
    EventPointer point = {};
