 ...
 * @tc.desc: Pull out the expansion screen
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(InputWindowsManagerTest, InputWindowsManagerTest_OnDisplayRemoved_001, TestSize.Level1)
{
    ...
    WIN_MGR->OnDisplayRemoved(displayGroupInfo);
    ASSERT_EQ(WIN_MGR->isDisplayRemoved_, true);
}

/**
 * @tc.name: InputWindowsManagerTest_OnDisplayRemoved_002
 * @tc.desc: Pull out the expansion screen
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(InputWindowsManagerTest, InputWindowsManagerTest_OnDisplayRemoved_002, TestSize.Level1)
{
    CALL_TEST_DEBUG;
    DisplayGroupInfo displayGroupInfo;
    ...
    displayGroupInfo.displaysInfo.push_back(displayInfo3);

    WIN_MGR->OnDisplayRemoved(displayGroupInfo);
    ASSERT_EQ(WIN_MGR->isDisplayRemoved_, false);
}
} // namespace MMI
} // namespace OHOS
