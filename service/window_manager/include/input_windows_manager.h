...
public:
    ...
    bool OnRemoveExpandedScreen(DisplayGroupInfo &displayGroupInfo);
...
void PointerDrawingManagerOnDisplayInfo(const DisplayGroupInfo &displayGroupInfo, bool removeResult = false);
