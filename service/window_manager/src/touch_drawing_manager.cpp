...
void TouchDrawingManager::DrawLabels()
{
    ...
    DrawRectItem(labelsCanvas_, viewP, rect, colorWhite_);
    if (isDownAction_ || !lastPointerItem_.empty()) {
        rect.left_ += itemW + TEXT_SPACEING;
        rect.right_ += itemW + TEXT_SPACEING;
        DrawRectItem(labelsCanvas_, viewX, rect, colorWhite_);
        rect.left_ += itemW + TEXT_SPACEING;
        rect.right_ += itemW + TEXT_SPACEING;
        DrawRectItem(labelsCanvas_, viewY, rect, colorWhite_);
    } else {
        Rosen::Drawing::Color color = dx == 0 ? colorWhite_ : colorRed_;
        rect.left_ += itemW + TEXT_SPACEING;
        rect.right_ += itemW + TEXT_SPACEING;
        DrawRectItem(labelsCanvas_, viewDx, rect, color);
        color = dy == 0 ? colorWhite_ : colorRed_;
        rect.left_ += itemW + TEXT_SPACEING;
        rect.right_ += itemW + TEXT_SPACEING;
	   ...
	   rect.left_ += itemW + TEXT_SPACEING;
    rect.right_ += itemW + TEXT_SPACEING;
    DrawRectItem(labelsCanvas_, viewXv, rect, colorWhite_);
    rect.left_ += itemW + TEXT_SPACEING;
    rect.right_ += itemW + TEXT_SPACEING;
    DrawRectItem(labelsCanvas_, viewYv, rect, colorWhite_);
    ...
    rect.left_ += itemW + TEXT_SPACEING;
    rect.right_ += itemW + TEXT_SPACEING;
    DrawRectItem(labelsCanvas_, viewPrs, rect, colorRed_);
