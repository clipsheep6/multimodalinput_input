...
{
    MMI_LOG_T("FreeScreensInfo...");
    if (!screens) {
        MMI_LOG_E("screens is null.");
        return;
    }
...
{
    MMI_LOG_T("FreeSeatsInfo...");
    if (!seats) {
        MMI_LOG_E("seats is null.");
        return;
    }
