...
void OHOS::MMI::WindowSwitch::SetCommonPointer(const EventPointer& point)
{
    ...
    CHK(EOK == memcpy_s(eventPointer_.deviceName, sizeof(eventPointer_.deviceName),
                        point.deviceName, sizeof(point.deviceName)), MEMCPY_SEC_FUN_FAIL);
    CHK(EOK == memcpy_s(eventPointer_.devicePhys, sizeof(eventPointer_.devicePhys),
                        point.devicePhys, sizeof(point.devicePhys)), MEMCPY_SEC_FUN_FAIL);
}
