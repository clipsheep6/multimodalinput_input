...
namespace MMI {
    ...
    std::unique_ptr<ISeatManager> ISeatManager::CreateInstance() 
    {
        return SeatManager::CreateInstance();
    }

    std::unique_ptr<ISeat> ISeat::CreateInstance(const std::string& seatId) {
        return Seat::CreateInstance(seatId);
    }
    ...
    std::unique_ptr<ITouchScreenSeat> ITouchScreenSeat::CreateInstance(const std::string& seatId, const std::string& seatName) {
        return TouchScreenSeat::CreateInstance(seatId, seatName);
    }
} // namespace MMI
} // namespace OHOS