...
#ifndef INPUT_CONNECT_STUB_H
#define INPUT_CONNECT_STUB_H
...
namespace OHOS {
namespace MMI {
class InputConnectStub : public IRemoteStub<IInputConnect> {
public:
    InputConnectStub() = default;
    DISALLOW_COPY_AND_MOVE(InputConnectStub);
    virtual ~InputConnectStub() = default;
...
protected:
    ...
    int32_t StubAddInterceptorHandler(MessageParcel& data, MessageParcel& reply);
    int32_t StubRemoveInterceptorHandler(MessageParcel& data, MessageParcel& reply);
    int32_t StubAddMonitorHandler(MessageParcel& data, MessageParcel& reply);
    int32_t StubRemoveMonitorHandler(MessageParcel& data, MessageParcel& reply);
