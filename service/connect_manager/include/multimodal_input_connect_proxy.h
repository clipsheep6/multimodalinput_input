...
public:
    ...
    virtual int32_t StartRemoteCooperateRes(bool isSucess, int32_t xPercent, int32_t yPercent) override;
    virtual int32_t StopRemoteCooperate() override;
    virtual int32_t StopRemoteCooperateRes(bool isSucess) override;
    virtual int32_t StartCooperateOtherRes(const std::string &srcNetworkId) override;
private:
