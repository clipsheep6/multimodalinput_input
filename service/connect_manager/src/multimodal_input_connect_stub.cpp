...
namespace MMI {
	namespace {
		static constexpr OHOS::HiviewDFX::HiLogLabel LABEL = { LOG_CORE, MMI_LOG_DOMAIN, "IMultimodalInputConnectStub" };
	}
int32_t IMultimodalInputConnectStub::OnRemoteRequest(
    uint32_t code, MessageParcel& data, MessageParcel& reply, MessageOption& option)
{
    MMI_LOGI("enter, code: %{public}d", code);
...
bool IMultimodalInputConnectStub::IsAuthorizedCalling() const
{
    ...
    MMI_LOGI("Calling uid: %{public}d", callingUid);
    return true;
