...
int32_t MultimodalInputConnectProxy::PrepareRemoteInput(const std::string& deviceId,
...
int32_t MultimodalInputConnectProxy::UnprepareRemoteInput(const std::string& deviceId,
    sptr<ICallDinput> prepareDinput)
{
    CALL_LOG_ENTER;
    MessageParcel data;
