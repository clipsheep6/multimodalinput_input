...
int32_t OHOS::MMI::EventDispatch::GestureRegisteredEventDispatch(const int32_t &idMsg,
...
int32_t OHOS::MMI::EventDispatch::DispatchRegEvent(const int32_t &idMsg, OHOS::MMI::UDSServer& udsServer,
