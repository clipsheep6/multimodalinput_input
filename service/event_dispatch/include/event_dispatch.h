...
protected:
    ...
    int32_t GestureRegisteredEventDispatch(const ID_MSG& idMsg, OHOS::MMI::UDSServer& udsServer,
        RegisteredEvent& registeredEvent, uint64_t preHandlerTime);
    int32_t RegisteredEventDispatch(const ID_MSG& idMsg, UDSServer& udsServer,
...
#ifdef OHOS_AUTO_TEST_FRAME
        int32_t SendStandardPktToAutoTest(UDSServer& udsServer,
