...
bool OHOS::MMI::InterceptorManagerGlobal::OnPointerEvent(std::shared_ptr<PointerEvent> pointerEvent)
{
    ...
    MMI_LOGT("interceptor-servereventTouchpad:actionTime:%{public},"
             "sourceType:%{public},pointerAction:%{public},"
             "pointerId:%{public},point.x:%{public},point.y:%{public},press:%{public}",
