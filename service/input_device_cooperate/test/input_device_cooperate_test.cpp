...
{
    CALL_INFO_TRACE;
    MMI_HILOGD("UpdateCrossingSwitchState002");
...
{
    CALL_INFO_TRACE;
    MMI_HILOGD("GetCrossingSwitchState001");
...
{
    CALL_INFO_TRACE;
    MMI_HILOGD("GetCrossingSwitchState002");
    std::string deviceId = "123";
...
{
    CALL_INFO_TRACE;
    MMI_HILOGD("RegisterCrossingStateListener001");
