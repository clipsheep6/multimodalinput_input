...
CooperateEventHandler::CooperateEventHandler(const std::shared_ptr<AppExecFwk::EventRunner> &runner)
...
bool CooperateEventHandler::ProxyPostTask(const Callback &callback, const std::string &name, int64_t delayTime)
{
