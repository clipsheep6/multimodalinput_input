 ...
 */
#ifndef I_MONITOR_EVENT_HANDLER_H
#define I_MONITOR_EVENT_HANDLER_H
...
public:
    IMonitorEventHandler(int32_t priority) : IInputEventHandler(priority) {}
...
#endif  // I_MONITOR_EVENT_HANDLER_H
