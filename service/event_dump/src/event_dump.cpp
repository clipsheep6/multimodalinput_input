...
void ChkConfig(int32_t fd)
{
    ...
    mprintf(fd, "\tDEF_MMI_DATA_ROOT: %s", DEF_MMI_DATA_ROOT);
    mprintf(fd, "\tUDS_SOCKET_NAME: %s", DEF_UDS_PATH);
    mprintf(fd, "\tLOG_CONFIG: %s", DEF_LOG_CONFIG);
    mprintf(fd, "\tEXP_CONFIG: %s", DEF_EXP_CONFIG);
    mprintf(fd, "\tEXP_SOPATH: %s", DEF_EXP_SOPATH);
    mprintf(fd, "\tXKB_CONFIG_PATH: %s", DEF_XKB_CONFIG);
}
