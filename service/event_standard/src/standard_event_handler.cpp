...
void OHOS::MMI::StandardEventHandler::StandardTouchEvent(libinput_event& event, StandardTouchStruct& data)
{
    ...
    switch (eventType) {
        case libinput_event_type::LIBINPUT_EVENT_POINTER_BUTTON: {
            PointerPressedStandar(event, data);
        }
        break;
...
void OHOS::MMI::StandardEventHandler::PointerPressedStandar(libinput_event& event, StandardTouchStruct& data)
{
...
void OHOS::MMI::StandardEventHandler::TipStandarEvent(libinput_event& event, StandardTouchStruct& data)
{
