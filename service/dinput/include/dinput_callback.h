...
public:
    PrepareDInputCallback(sptr<ICallDinput> prepareDinput) { callback_ = prepareDinput; }
...
public:
    StartDInputCallback(sptr<ICallDinput> prepareDinput) { callback_ = prepareDinput; }
...
public:
    StopDInputCallback(sptr<ICallDinput> prepareDinput) { callback_ = prepareDinput; }
...
public:
    UnprepareDInputCallback(sptr<ICallDinput> prepareDinput) { callback_ = prepareDinput; }
