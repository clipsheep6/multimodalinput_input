...
OHOS::DistributedHardware::DistributedInput::DInputServerType DInputManager::GetDInputServerType(
...
OHOS::DistributedHardware::DistributedInput::DInputServerType DInputManager::IsStartDistributedInput(
    uint32_t inputAbility)
{
    MMI_HILOGD("enter: inputAbility:%{public}d", inputAbility);
    return OHOS::DistributedHardware::DistributedInput::DistributedInputKit
        ::IsStartDistributedInput(inputAbility);
}
...
bool DInputManager::IsNeedFilterOut(const std::string deviceId, const std::shared_ptr<KeyEvent> key)
{
    ...
    MMI_HILOGD("deviceId:%{public}s, keyCode:%{public}d, keyAction:%{public}d",
...
{
    return OHOS::DistributedHardware::DistributedInput::DistributedInputKit
        ::IsNeedFilterOut(deviceId, businessEvent);
}
...
int32_t DInputManager::PrepareRemoteInput(const std::string& deviceId, sptr<ICallDinput> prepareDinput)
{
    ...
    return OHOS::DistributedHardware::DistributedInput::DistributedInputKit
        ::PrepareRemoteInput(deviceId, callback);
}
...
int32_t DInputManager::UnprepareRemoteInput(const std::string& deviceId, sptr<ICallDinput> prepareDinput)
{
    ...
    return OHOS::DistributedHardware::DistributedInput::DistributedInputKit
        ::UnprepareRemoteInput(deviceId, callback);
}

int32_t DInputManager::StartRemoteInput(const std::string& deviceId,
    uint32_t inputAbility, sptr<ICallDinput> prepareDinput)
{
    ...
    return OHOS::DistributedHardware::DistributedInput::DistributedInputKit
        ::StartRemoteInput(deviceId, inputAbility, callback);
}

int32_t DInputManager::StopRemoteInput(const std::string& deviceId,
    uint32_t inputAbility, sptr<ICallDinput> prepareDinput)
{
    CALL_LOG_ENTER;
    sptr<StopDInputCallback> callback = new StopDInputCallback(prepareDinput);
    return OHOS::DistributedHardware::DistributedInput::DistributedInputKit
        ::StopRemoteInput(deviceId, inputAbility, callback);
}
