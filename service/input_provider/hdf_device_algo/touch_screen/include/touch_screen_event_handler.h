...
public:
    ...
    static std::shared_ptr<TouchScreenEventHandler> CreateInstance(std::shared_ptr<IInputContext> context);
...
protected:
    TouchScreenEventHandler(std::shared_ptr<IInputContext> context);
...
private:
    ...
    std::shared_ptr<IInputContext> context_;
};
} // namespace MMI
} // namespace OHOS
