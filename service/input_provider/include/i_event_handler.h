...
struct IEventHandlerStruct {
    std::shared_ptr<OHOS::MMI::IEventHandler> eventHandler;
};
typedef bool GetIEventHandler(std::shared_ptr<OHOS::MMI::IInputContext> context, int32_t capabilities, IEventHandlerStruct **s);
