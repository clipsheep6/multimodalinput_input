...
public:
    explicit IInputDevice(std::shared_ptr<IInputContext> context, uint32_t index) : context_(context), index_(index) {}
    ...
    virtual std::shared_ptr<InputDevice> GetInputDevice() = 0;
