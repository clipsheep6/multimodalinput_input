...
bool InjectKeyEvent(const uint8_t* data, const size_t size, size_t &startPos)
{
    ...
    OHOS::DelayedSingleton<MMIService>::GetInstance()->InjectKeyEvent(injectDownEvent);
    ...
    OHOS::DelayedSingleton<MMIService>::GetInstance()->InjectKeyEvent(injectUpEvent);
    return true;
}
...
bool InjectTouchEvent(const uint8_t* data, const size_t size, size_t &startPos)
{
    ...
    OHOS::DelayedSingleton<MMIService>::GetInstance()->InjectPointerEvent(pointerDownEvent);
    ...
    MMI_HILOGD("Call InputManager::InjectTouchEvent");
    OHOS::DelayedSingleton<MMIService>::GetInstance()->InjectPointerEvent(pointerUpEvent);
    return true;
}
