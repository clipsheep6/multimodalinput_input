...
public:
    ...
    static napi_value SetPointerSwitch(napi_env env, napi_callback_info info);
    static napi_value SetPointerSmartChangeSwitch(napi_env env, napi_callback_info info);
