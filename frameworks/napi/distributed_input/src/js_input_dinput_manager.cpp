...
napi_value JsInputDinputManager::StartRemoteInput(napi_env env, std::string& deviceId,
...
napi_value JsInputDinputManager::StopRemoteInput(napi_env env, std::string& deviceId,
    std::vector<uint32_t> inputAbility, napi_ref handle)
{
    auto* cb = CreateCallbackInfo<int32_t>(env, handle);
    uint32_t ability = ChangeToAbilityType(inputAbility);
