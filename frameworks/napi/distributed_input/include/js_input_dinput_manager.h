...
public:
    napi_value PrepareRemoteInput(napi_env env, std::string& deviceId, napi_ref handle);
    napi_value UnprepareRemoteInput(napi_env env, std::string& deviceId, napi_ref handle);
    napi_value StartRemoteInput(napi_env env, std::string& deviceId, std::vector<uint32_t> inputAbility, napi_ref handle);
    napi_value StopRemoteInput(napi_env env, std::string& deviceId, std::vector<uint32_t> inputAbility, napi_ref handle);
    napi_value GetRemoteInputAbility(napi_env env, napi_ref handle, std::string deviceId);
    ...
    static uint32_t ChangeToAbilityType(std::vector<uint32_t> abilities);
