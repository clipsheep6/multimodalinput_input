...
public:
    ...
    napi_value StartRemoteInput(napi_env env, std::string& deviceId,
        std::vector<uint32_t> inputAbility, napi_ref handle);
    napi_value StopRemoteInput(napi_env env, std::string& deviceId,
        std::vector<uint32_t> inputAbility, napi_ref handle);
