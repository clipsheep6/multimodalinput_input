...
napi_value JsKeyCode::Export(napi_env env, napi_value exports)
{
    ...
    napi_property_descriptor desc[] = {
        ...
        DECLARE_NAPI_STATIC_PROPERTY("KEYCODE_LAUNCHER_MENU", GetNapiInt32(env, KeyEvent::KEYCODE_LAUNCHER_MENU)),
        DECLARE_NAPI_STATIC_PROPERTY("KEYCODE_CALL_NOTIFICATION_CENTER", GetNapiInt32(env, KeyEvent::KEYCODE_CALL_NOTIFICATION_CENTER)),
        DECLARE_NAPI_STATIC_PROPERTY("KEYCODE_CALL_CONTROL_CENTER", GetNapiInt32(env, KeyEvent::KEYCODE_CALL_CONTROL_CENTER)),
    };
