...
public:
    ...
    static void EmitJsEnable(sptr<JsUtil::CallbackInfo> cb, std::string deviceId, CooperationMessage msg);
    static void EmitJsStart(sptr<JsUtil::CallbackInfo> cb, std::string deviceId, CooperationMessage msg);
    static void EmitJsStop(sptr<JsUtil::CallbackInfo> cb, std::string deviceId, CooperationMessage msg);
