...
public:
    ...
    static napi_value GetEnableInfo(const sptr<CallbackInfo> &cb);
    static napi_value GetStartInfo(const sptr<CallbackInfo> &cb);
    static napi_value GetStopInfo(const sptr<CallbackInfo> &cb);
    static napi_value GetStateInfo(const sptr<CallbackInfo> &cb);
