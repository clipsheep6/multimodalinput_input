...
namespace MMI {
namespace {
constexpr OHOS::HiviewDFX::HiLogLabel LABEL = { LOG_CORE, MMI_LOG_DOMAIN, "native_register_module" };
} // namespace

static void DeclareDeviceCooperateInterface(napi_env env, napi_value exports)
{
    napi_property_descriptor functions[] = {
        DECLARE_NAPI_STATIC_FUNCTION("enable", CooperateEnable::Enable),
        ...
        DECLARE_NAPI_STATIC_FUNCTION("on", CooperateMonitor::On),
        DECLARE_NAPI_STATIC_FUNCTION("off", CooperateMonitor::Off),
    };
...
static napi_value CreateInt32(napi_env env, CooperationState msg)
{
...
static void DeclaerDeviceCooperateData(napi_env env, napi_value exports)
{
    napi_property_descriptor msg[] = {
        DECLARE_NAPI_STATIC_PROPERTY("MSG_COOPERATE_OPEN_SUCCESS",
            CreateInt32(env, CooperationState::MSG_COOPERATE_OPEN_SUCCESS)),
        DECLARE_NAPI_STATIC_PROPERTY("MSG_COOPERATE_OPEN_FAIL",
            CreateInt32(env, CooperationState::MSG_COOPERATE_OPEN_FAIL)),
        DECLARE_NAPI_STATIC_PROPERTY("MSG_COOPERATE_INFO_START",
            CreateInt32(env, CooperationState::MSG_COOPERATE_INFO_START)),
        DECLARE_NAPI_STATIC_PROPERTY("MSG_COOPERATE_INFO_SUCCESS",
            CreateInt32(env, CooperationState::MSG_COOPERATE_INFO_SUCCESS)),
        DECLARE_NAPI_STATIC_PROPERTY("MSG_COOPERATE_INFO_FAIL",
            CreateInt32(env, CooperationState::MSG_COOPERATE_INFO_FAIL)),
        DECLARE_NAPI_STATIC_PROPERTY("MSG_COOPERATE_CLOSE",
            CreateInt32(env, CooperationState::MSG_COOPERATE_CLOSE)),
        DECLARE_NAPI_STATIC_PROPERTY("MSG_COOPERATE_CLOSE_SUCCESS",
            CreateInt32(env, CooperationState::MSG_COOPERATE_CLOSE_SUCCESS)),
        DECLARE_NAPI_STATIC_PROPERTY("MSG_COOPERATE_STOP",
            CreateInt32(env, CooperationState::MSG_COOPERATE_STOP)),
        DECLARE_NAPI_STATIC_PROPERTY("MSG_COOPERATE_STOP_SUCCESS",
            CreateInt32(env, CooperationState::MSG_COOPERATE_STOP_SUCCESS)),
        DECLARE_NAPI_STATIC_PROPERTY("MSG_COOPERATE_STOP_FAIL",
            CreateInt32(env, CooperationState::MSG_COOPERATE_STOP_FAIL)),
        DECLARE_NAPI_STATIC_PROPERTY("MSG_COOPERATE_STATE_ON",
            CreateInt32(env, CooperationState::MSG_COOPERATE_STATE_ON)),
        DECLARE_NAPI_STATIC_PROPERTY("MSG_COOPERATE_STATE_OFF",
            CreateInt32(env, CooperationState::MSG_COOPERATE_STATE_OFF)),
    };
