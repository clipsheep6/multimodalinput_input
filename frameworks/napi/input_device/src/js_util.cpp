...
napi_value JsUtil::GetDeviceInfo(const sptr<CallbackInfo> &cb)
{
    CHKPP(cb);
    CHKPP(cb->env);
...
bool JsUtil::GetDeviceAxisInfo(const sptr<CallbackInfo> &cb, napi_value &object)
{
    CHKPF(cb);
    CHKPF(cb->env);
...
bool JsUtil::GetDeviceSourceType(const sptr<CallbackInfo> &cb, napi_value &object)
{
    CHKPF(cb);
    CHKPF(cb->env);
    CHKPF(cb->data.device);
