...
public:
    ...
    static napi_value GetDeviceInfo(const sptr<CallbackInfo> &cb);
    static bool GetDeviceAxisInfo(const sptr<CallbackInfo> &cb, napi_value &object);
    static bool GetDeviceSourceType(const sptr<CallbackInfo> &cb, napi_value &object);
