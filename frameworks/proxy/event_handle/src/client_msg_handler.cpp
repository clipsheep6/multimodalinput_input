...
bool OHOS::MMI::ClientMsgHandler::Init()
{
    // LCOV_EXCL_START
    MsgCallback funs[] = {
        {ID_MSG_ON_KEY, std::bind(&ClientMsgHandler::OnKey, this, std::placeholders::_1, std::placeholders::_2)},
        {ID_MSG_ON_TOUCH, std::bind(&ClientMsgHandler::OnTouch, this, std::placeholders::_1, std::placeholders::_2)},
        {ID_MSG_ON_COPY, std::bind(&ClientMsgHandler::OnCopy, this, std::placeholders::_1, std::placeholders::_2)},
        {
            ID_MSG_ON_SHOW_MENU,
            std::bind(&ClientMsgHandler::OnShowMenu, this, std::placeholders::_1, std::placeholders::_2)
        },
        {ID_MSG_ON_SEND, std::bind(&ClientMsgHandler::OnSend, this, std::placeholders::_1, std::placeholders::_2)},
        {ID_MSG_ON_PASTE, std::bind(&ClientMsgHandler::OnPaste, this, std::placeholders::_1, std::placeholders::_2)},
        {ID_MSG_ON_CUT, std::bind(&ClientMsgHandler::OnCut, this, std::placeholders::_1, std::placeholders::_2)},
        {ID_MSG_ON_UNDO, std::bind(&ClientMsgHandler::OnUndo, this, std::placeholders::_1, std::placeholders::_2)},
        {
            ID_MSG_ON_REFRESH,
        ...
        {ID_MSG_ON_CANCEL, std::bind(&ClientMsgHandler::OnCancel, this, std::placeholders::_1, std::placeholders::_2)},
        {
            ID_MSG_ON_ENTER,
        ...
        {ID_MSG_ON_NEXT, std::bind(&ClientMsgHandler::OnNext, this, std::placeholders::_1, std::placeholders::_2)},
        {ID_MSG_ON_BACK, std::bind(&ClientMsgHandler::OnBack, this, std::placeholders::_1, std::placeholders::_2)},
        {ID_MSG_ON_PRINT, std::bind(&ClientMsgHandler::OnPrint, this, std::placeholders::_1, std::placeholders::_2)},
        {ID_MSG_ON_PLAY, std::bind(&ClientMsgHandler::OnPlay, this, std::placeholders::_1, std::placeholders::_2)},
        {ID_MSG_ON_PAUSE, std::bind(&ClientMsgHandler::OnPause, this, std::placeholders::_1, std::placeholders::_2)},
        {
        ...
        {ID_MSG_ON_RECENT, std::bind(&ClientMsgHandler::OnRecent, this, std::placeholders::_1, std::placeholders::_2)},
        {
        ...
        {ID_MSG_ON_SEARCH, std::bind(&ClientMsgHandler::OnSearch, this, std::placeholders::_1, std::placeholders::_2)},
        {
            ID_MSG_ON_CLOSEPAGE,
        ...
        {ID_MSG_ON_MUTE, std::bind(&ClientMsgHandler::OnMute, this, std::placeholders::_1, std::placeholders::_2)},
        {ID_MSG_ON_ANSWER, std::bind(&ClientMsgHandler::OnAnswer, this, std::placeholders::_1, std::placeholders::_2)},
        {ID_MSG_ON_REFUSE, std::bind(&ClientMsgHandler::OnRefuse, this, std::placeholders::_1, std::placeholders::_2)},
        {ID_MSG_ON_HANG_UP, std::bind(&ClientMsgHandler::OnHangup, this, std::placeholders::_1, std::placeholders::_2)},
        {
...
void OHOS::MMI::ClientMsgHandler::OnMsgHandler(const OHOS::MMI::UDSClient& client, OHOS::MMI::NetPacket& pkt)
{
    ...
    TimeCostChkfp1("ClientMsgHandler::OnMsgHandler", "overtime 300(us)", MAX_OVER_TIME, id);
    auto fun = GetFun(id);
    if (!fun) {
...
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnCopy");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnShowMenu(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnShowMenu");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnSend(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnSend");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnPaste(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnPaste");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnCut(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnCut");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnUndo(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnUndo");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnRefresh(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnRefresh");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnStartDrag(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnStartDrag");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnCancel(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnCancel");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnEnter(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnEnter");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnPrevious(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnPrevious");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnNext(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnNext");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnBack(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnBack");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnPrint(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnPrint");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnPlay(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnPlay");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnPause(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnPause");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnMediaControl(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnMediaControl");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnScreenShot(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnScreenShot");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnScreenSplit(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnScreenSplit");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnStartScreenRecord(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnStartScreenRecord");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnStopScreenRecord(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnStopScreenRecord");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnGotoDesktop(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnGotoDesktop");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnRecent(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnRecent");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnShowNotification(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnShowNotification");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnLockScreen(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnLockScreen");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnSearch(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnSearch");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnClosePage(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnClosePage");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnLaunchVoiceAssistant(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnLaunchVoiceAssistant");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnMute(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnMute");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnAnswer(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnAnswer");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnRefuse(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnRefuse");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnHangup(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnHangup");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
int32_t OHOS::MMI::ClientMsgHandler::OnTelephoneControl(const UDSClient& client, NetPacket& pkt)
{
    ...
    MultimodalEvent multEvent;
#ifdef OHOS_AUTO_TEST_FRAME
    PackedData(multEvent, client, pkt, "OnTelephoneControl");
#else
    PackedData(multEvent, client, pkt);
#endif  // OHOS_AUTO_TEST_FRAME
...
#ifdef OHOS_AUTO_TEST_FRAME
int32_t OHOS::MMI::ClientMsgHandler::PackedData(MultimodalEvent& multEvent, const UDSClient& client, NetPacket& pkt,
