...
int32_t OHOS::MMI::ClientMsgHandler::OnKey(const UDSClient& client, NetPacket& pkt)
{
    ...
    MMI_LOGT("\nevent dispatcher of client:\neventKeyboard:time=%{public}u;key=%{public}u;deviceId=%{public}u;"
...
int32_t OHOS::MMI::ClientMsgHandler::PackedData(MultimodalEvent& multEvent, const UDSClient& client, NetPacket& pkt, const std::string& funName)
{
...
void OHOS::MMI::ClientMsgHandler::AnalysisPointEvent(const UDSClient& client, NetPacket& pkt) const
{
    ...
    MMI_LOGT("\nevent dispatcher of client: mouse_data \neventPointer:time=%{public}u; eventType=%{public}d;"
...
void OHOS::MMI::ClientMsgHandler::AnalysisTouchEvent(const UDSClient& client, NetPacket& pkt) const
{
    ...
    */
    ...
    MMI_LOGT("\nevent dispatcher of client:\neventTouch:time=%{public}u;deviceId=%{public}u;"
...
void OHOS::MMI::ClientMsgHandler::AnalysisTouchPadEvent(const UDSClient& client, NetPacket& pkt) const
{
    ...
    MMI_LOGT("\nevent dispatcher of client: event tablet Pad :time=%{public}u;deviceType=%{public}u;"
...
{
    MMI_LOGT("\nevent dispatcher of client: event tablet Tool :time=%{public}u; deviceType=%{public}u; "
...
void OHOS::MMI::ClientMsgHandler::AnalysisGestureEvent(const UDSClient& client, NetPacket& pkt) const
{
    ...
    MMI_LOGT("\nevent dispatcher of client: event Gesture :time=%{public}u;deviceId=%{public}u;"
             ...
             "windowId=%{public}d;preHandlerTime=%{public}u;\n***************************************************\n",
