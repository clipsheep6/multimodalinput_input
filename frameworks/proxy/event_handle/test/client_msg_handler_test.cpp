...
public:
    ...
    {
        OHOS::MMI::UDSClient clientObj;
        NetPacket netPacket(msgId);
        netPacket << msgId;
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_KEY);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_TOUCH);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_COPY);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_SHOW_MENU);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_SEND);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_PASTE);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_CUT);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_UNDO);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_REFRESH);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_START_DRAG);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_CANCEL);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_ENTER);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_PREVIOUS);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_NEXT);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_BACK);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_PRINT);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_PLAY);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_PAUSE);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_MEDIA_CONTROL);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_SCREEN_SHOT);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_SCREEN_SPLIT);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_START_SCREEN_RECORD);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_STOP_SCREEN_RECORD);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_GOTO_DESKTOP);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_RECENT);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_SHOW_NOTIFICATION);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_LOCK_SCREEN);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_SEARCH);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_CLOSEPAGE);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_LAUNCH_VOICE_ASSISTANT);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_MUTE);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_ANSWER);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_REFUSE);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_HANG_UP);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_TELEPHONE_CONTROL);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_JOYSTICK);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_GETMMIINFO_ACK);
...
{
    UDSClient clientObj;
    NetPacket netPacket(INPUT_DEVICE_CAP_POINTER);
...
{
    UDSClient clientObj;
    NetPacket netPacket(INPUT_DEVICE_CAP_TOUCH);
...
{
    UDSClient clientObj;
    NetPacket netPacket(EVENT_KEYBOARD);
...
{
    UDSClient clientObj;
    NetPacket netPacket(EVENT_MULTIMODAL);
...
{
    UDSClient clientObj;
    NetPacket netPacket(INPUT_DEVICE_CAP_JOYSTICK);
...
{
    UDSClient clientObj;
    NetPacket netPacket(INPUT_DEVICE_CAP_AISENSOR);
...
{
    UDSClient clientObj;
    NetPacket netPacket(INPUT_DEVICE_CAP_SWITCH);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_DEVICEADDED);
...
{
    UDSClient clientObj;
    NetPacket netPacket(ID_MSG_ON_DEVICE_REMOVED);
