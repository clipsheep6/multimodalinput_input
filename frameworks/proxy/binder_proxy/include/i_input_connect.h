...
#ifndef I_INPUT_CONNECT_H
#define I_INPUT_CONNECT_H
...
namespace OHOS {
namespace MMI {
class IInputConnect : public IRemoteBroker {
public:
    enum {
        ALLOC_SOCKET_FD = 0,
        ...
        REMOVE_INTERCEPTOR_HANDLER = 9,
        ADD_MONITOR_HANDLER = 10,
        REMOVE_MONITOR_HANDLER = 11,
        MARK_EVENT_CONSUMED = 12,
        MOVE_MOUSE = 13,
        INJECT_KEY_EVENT = 14,
        INJECT_POINTER_EVENT = 15,
        SET_ANR_OBSERVER = 16,
        SUPPORT_KEYS = 17,
        GET_DEVICE_IDS = 18,
        GET_DEVICE = 19,
        REGISTER_DEV_MONITOR = 20,
        UNREGISTER_DEV_MONITOR = 21,
        GET_KEYBOARD_TYPE = 22,
        SET_POINTER_SPEED = 23,
        GET_POINTER_SPEED = 24,
        SET_POINTER_STYLE = 25,
        GET_POINTER_STYLE = 26,
        SET_FUNCTION_KEY_STATE = 27,
        GET_FUNCTION_KEY_STATE = 28,
        RMV_INPUT_EVENT_FILTER = 29,
    ...
    virtual int32_t AddInterceptorHandler(HandleEventType eventType, int32_t priority, uint32_t deviceTags) = 0;
    virtual int32_t RemoveInterceptorHandler(HandleEventType eventType, int32_t priority, uint32_t deviceTags) = 0;
    virtual int32_t AddMonitorHandler(HandleEventType eventType) = 0;
    virtual int32_t RemoveMonitorHandler(HandleEventType eventType) = 0;
