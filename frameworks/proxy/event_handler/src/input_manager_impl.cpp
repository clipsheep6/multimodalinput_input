...
int32_t InputManagerImpl::GetCurrentPointerStyle(int32_t &style)
{
    CALL_DEBUG_ENTER;
    return MULTIMODAL_INPUT_CONNECT_MGR->GetCurrentPointerStyle(style);
}
 
int32_t InputManagerImpl::SetIntelligentChangeState(bool state)
{
    CALL_DEBUG_ENTER;
    return MULTIMODAL_INPUT_CONNECT_MGR->SetIntelligentChangeState(state);
}
 
int32_t InputManagerImpl::GetIntelligentChangeState(bool &state)
{
    CALL_DEBUG_ENTER;
    return MULTIMODAL_INPUT_CONNECT_MGR->GetIntelligentChangeState(state);
}
