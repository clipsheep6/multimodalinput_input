...
bool GetPointerItems(std::shared_ptr<PointerEvent> pointerEvent, std::vector<PointerEvent::PointerItem> &pointerItems)
{
...
std::string GetTraceString(const std::vector<PointerEvent::PointerItem> &pointerItems)
{
    std::string traceStr;
