...
void MMIClient::SetEventHandler(std::shared_ptr<AppExecFwk::EventHandler> eventHandler, bool newThread)
{
    CHKPV(eventHandler);
    eventHandler_ = eventHandler;
    isNeedNewThread_ = newThread;
}
...
bool MMIClient::Start()
{
    ...
    //     return false;
    // }
    if (!InputMgrImpl->InitEventHandler(eventHandler_, isNeedNewThread_)) {
