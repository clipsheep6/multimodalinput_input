...
private:
    static void PrintInfoLog(const std::shared_ptr<KeyEvent> event)
    {
        ...
        MMI_HILOGI("InputTracking id:%{public}d, KeyCode:%{public}d,ActionTime:%{public}" PRId64 ",EventType:%{public}s,"
            "KeyAction:%{public}s,NumLock:%{public}d,CapsLock:%{public}d,ScrollLock:%{public}d,keyItemsCount:%{public}zu",
