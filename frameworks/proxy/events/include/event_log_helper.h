...
private:
    ...
    {
        std::string userType = OHOS::system::GetParameter("const.logsystem.versiontype", "default");
        if (userType == "beta") {
    ...
    static void PrintInfoLog(const std::shared_ptr<KeyEvent> event, const LogHeader &lh)
    {
        ...
        if (!IsBetaVersion()) {
<<<<<<< Updated upstream
            MMI_HILOG_HEADER(LOG_INFO, lh, "See InputTracking-Dict, I:%{public}d" PRId64
                ", ET:%{public}s, KA:%{public}s, KIC:%{public}zu, "
                "DI:%{public}d, IR:%{public}s, SI:%{public}s",
=======
            MMI_HILOG_HEADER(LOG_INFO, lh, "See InputTracking-Dict, I:%{public}d" PRId64 ", ET:%{public}s," 
...
>>>>>>> Stashed changes
    ...
    static void Print(const std::shared_ptr<KeyEvent> event, const LogHeader &lh)
    {
        ...
        std::vector<KeyEvent::KeyItem> eventItems{ event->GetKeyItems() };
        if (!IsBetaVersion()) {
            MMI_HILOG_HEADER(LOG_DEBUG, lh, "KI:%{public}d, ET:%{public}s, F:%{public}d, KA:%{public}s, EN:%{public}d"
                ", KIC:%{public}zu",
...
>>>>>>> Stashed changes
        ...
        for (const auto &item : eventItems) {
            if (!IsBetaVersion()) {
<<<<<<< Updated upstream
                MMI_HILOG_HEADER(LOG_INFO, lh, "DN:%{public}d" PRId64 ", IP:%{public}d, "
                    "GU:%{public}d", item.GetDeviceId(), item.IsPressed(), item.GetUnicode());
=======
...
>>>>>>> Stashed changes
    ...
    static void PrintInfoLog(const std::shared_ptr<PointerEvent> event, const LogHeader &lh)
    {
        ...
        if (!IsBetaVersion()) {
<<<<<<< Updated upstream
            MMI_HILOGD("See InputTracking-Dict I:%{public}d, ET:%{public}s" PRId64
                ", PA:%{public}s, ST:%{public}s, DI:%{public}d, WI:%{public}d, DPT:%{public}d"
                ", SI:%{public}s, PBS:%{public}zu",
=======
            MMI_HILOGD("See InputTracking-Dict I:%{public}d, ET:%{public}s, PA:%{public}s, ST:%{public}s," 
                "DI:%{public}d, WI:%{public}d, DPT:%{public}d, SI:%{public}s, PBS:%{public}zu",
>>>>>>> Stashed changes
                event->GetId(), InputEvent::EventTypeToString(event->GetEventType()),
...
<<<<<<< Updated upstream
            MMI_HILOGD("See InputTracking-Dict I:%{public}d, ET:%{public}s, AT:%{public}" PRId64
                ...
                ", SI:%{public}s, PBS:%{public}zu",
=======
            MMI_HILOGD("See InputTracking-Dict I:%{public}d, ET:%{public}s, AT:%{public}" PRId64 ", PA:%{public}s,"
                "ST:%{public}s, DI:%{public}d, WI:%{public}d, DPT:%{public}d, SI:%{public}s, PBS:%{public}zu",
>>>>>>> Stashed changes
        ...
        for (const auto &pointerId : pointerIds) {
            ...
            if (event->HasFlag(InputEvent::EVENT_FLAG_PRIVACY_MODE)) {
                if (!IsBetaVersion()) {
<<<<<<< Updated upstream
                    MMI_HILOG_HEADER(LOG_INFO, lh, "PI:%{public}d" PRId64 ", IP:%{public}d,"
                        "P:%{public}.2f, LA:%{public}d, SA:%{public}d, WI:%{public}d, "
                        "OPI:%{public}d",
                        pointerId, item.IsPressed(),
                        item.GetPressure(), item.GetLongAxis(), item.GetShortAxis(), item.GetTargetWindowId(),
                        item.GetOriginPointerId());
=======
                    MMI_HILOG_HEADER(LOG_INFO, lh, "PI:%{public}d, IP:%{public}d, P:%{public}.2f, "
                        "LA:%{public}d, SA:%{public}d, WI:%{public}d, OPI:%{public}d",
                        pointerId, item.IsPressed(), item.GetPressure(), item.GetLongAxis(), item.GetShortAxis(),
                        item.GetTargetWindowId(), item.GetOriginPointerId());
>>>>>>> Stashed changes
                } else {
...
<<<<<<< Updated upstream
                MMI_HILOG_HEADER(LOG_INFO, lh, "PI:%{public}d" PRId64 ", IP:%{public}d, "
                    "P:%{public}.2f, LA:%{public}d, SA:%{public}d, WI:%{public}d, OPI:%{public}d, SI:%{public}s",
                    pointerId, item.IsPressed(),
                    item.GetPressure(), item.GetLongAxis(), item.GetShortAxis(), item.GetTargetWindowId(),
                    item.GetOriginPointerId(), isSimulate.c_str());
=======
                MMI_HILOG_HEADER(LOG_INFO, lh, "PI:%{public}d, IP:%{public}d, P:%{public}.2f, LA:%{public}d, "
                    "SA:%{public}d, WI:%{public}d, OPI:%{public}d, SI:%{public}s",
                    pointerId, item.IsPressed(), item.GetPressure(), item.GetLongAxis(), item.GetShortAxis(),
                    item.GetTargetWindowId(), item.GetOriginPointerId(), isSimulate.c_str());
>>>>>>> Stashed changes
            } else {
    ...
    static void Print(const std::shared_ptr<PointerEvent> event, const LogHeader &lh)
    {
        ...
        if (!IsBetaVersion()) {
<<<<<<< Updated upstream
            MMI_HILOG_HEADER(LOG_DEBUG, lh, "ET:%{public}s" PRId64 ", SIT:%{public}" PRIu64 ", A:%{public}d, "
                ", F:%{public}d, PA:%{public}s, ST:%{public}s, BI:%{public}d, VAV:%{public}.5f, "
...
=======
            MMI_HILOG_HEADER(LOG_DEBUG, lh, "ET:%{public}s, SIT:%{public}" PRIu64 ", A:%{public}d, "
                ", F:%{public}d, PA:%{public}s, ST:%{public}s, BI:%{public}d, VAV:%{public}.5f, HAV:%{public}.5f"
                ", PAV:%{public}.5f, PAV:%{public}.5f, XAV:%{public}.5f, YAV:%{public}.5f, ZAV:%{public}.5f, "
                "RZAV:%{public}.5f, GAV:%{public}.5f, BAV:%{public}.5f, HXAV:%{public}.5f, HYAV:%{public}.5f, "
...
=======
            MMI_HILOG_HEADER(LOG_DEBUG, lh, "ET:%{public}s, AT:%{public}" PRId64 ", SIT:%{public}, A:%{public}d, "
>>>>>>> Stashed changes
        ...
        for (const auto &pointerId : pointerIds) {
            ...
            if (event->HasFlag(InputEvent::EVENT_FLAG_PRIVACY_MODE)) {
                if (!IsBetaVersion()) {
<<<<<<< Updated upstream
                    MMI_HILOG_HEADER(LOG_DEBUG, lh,"PI:%{public}d" PRId64 ", IP:%{public}d, "
                        "TX:%.2f, TY:%.2f" PRId64 ",P:%{public}.2f, ToolType:%{public}d, LA:%{public}d, "
=======
                    MMI_HILOG_HEADER(LOG_DEBUG, lh,"PI:%{public}d, IP:%{public}d, "
                        "TX:%.2f, TY:%.2f, P:%{public}.2f, ToolType:%{public}d, LA:%{public}d, "
>>>>>>> Stashed changes
                        "SA:%{public}d, RawDx:%d, RawDy:%d", 
                        pointerId, item.IsPressed(), item.GetTiltX(), item.GetTiltY(),
...
<<<<<<< Updated upstream
                    "PI:%{public}d" PRId64 ", IP:%{public}d "
                    "TX:%{public}.2f, TY:%{public}.2f" PRId64 ", P:%{public}.2f, ToolType:%{public}d, "
                    "LA:%{public}d, SA:%{public}d, RawDx:%{public}d, RawDy:%{public}d",
=======
                    "PI:%{public}d, IP:%{public}d, TX:%{public}.2f, TY:%{public}.2f, P:%{public}.2f,"
                    "ToolType:%{public}d, LA:%{public}d, SA:%{public}d, RawDx:%{public}d, RawDy:%{public}d",
>>>>>>> Stashed changes
                    pointerId, item.IsPressed(), item.GetDisplayX(),
                    item.GetTiltX(), item.GetTiltY(), item.GetPressure(), item.GetToolType(), item.GetLongAxis(),
