...
void EventLogHelper::Print(const std::shared_ptr<PointerEvent> event)
{
    std::vector<int32_t> pointerIds { event->GetPointerIds() };
    MMI_HILOGD("EventType:%{public}s,ActionTime:%{public}" PRId64 ",Action:%{public}d,ActionStartTime:%{public}" PRId64 ",Flag:%{public}d,PointerAction:%{public}s,SourceType:%{public}s,ButtonId:%{public}d,VerticalAxisValue:%{public}.2f,HorizontalAxisValue:%{public}.2f,PinchAxisValue:%{public}.2f,PointerCount:%{public}zu ,EventNumber:%{public}d",
