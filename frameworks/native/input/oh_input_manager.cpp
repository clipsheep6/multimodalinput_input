...
static bool g_isSetRemoveMonitorCallback { false };
...
{
    MMI_HILOGI("RemoveMonitor Enter");
    ...
    MMI_HILOGI("RemoveMonitor leave");
}
...
static void SetRemoveMonitorCallback()
{
    ...
    g_isSetRemoveMonitorCallback = true;
}
...
Input_Result OH_Input_AddKeyEventMonitor(Input_KeyEventCallback callback)
{
    ...
    if (g_keyMonitorId == INVALID_MONITOR_ID) {
        ...
        g_keyMonitorId = ret;
        if (!g_isSetRemoveMonitorCallback) {
