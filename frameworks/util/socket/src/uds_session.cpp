...
OHOS::MMI::UDSSession::UDSSession(const std::string& programName, const int moduleType, const int32_t fd) : programName_(programName), moduleType_(moduleType), fd_(fd)
{
    UpdateDescript();
}
