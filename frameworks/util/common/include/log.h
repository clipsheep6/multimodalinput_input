...
#define MMI_LOGT(fmt, ...) do {\
    OHOS::MMI::LogManager::GetInstance().PushFormat(OHOS::MMI::LL_TRACE, __FILE__, __LINE__, MMI_FUNC_FMT fmt, MMI_FUNC_INFO, ##__VA_ARGS__);\
    OHOS::HiviewDFX::HiLog::Debug(LABEL, MMI_FUNC_FMT fmt, MMI_FUNC_INFO, ##__VA_ARGS__);\
} while (0)

#define MMI_LOGD(fmt, ...) do {\
    OHOS::MMI::LogManager::GetInstance().PushFormat(OHOS::MMI::LL_DEBUG, __FILE__, __LINE__, MMI_FUNC_FMT fmt, MMI_FUNC_INFO, ##__VA_ARGS__);\
    OHOS::HiviewDFX::HiLog::Debug(LABEL, MMI_FUNC_FMT fmt, MMI_FUNC_INFO, ##__VA_ARGS__);\
} while (0)

#define MMI_LOGI(fmt, ...) do {\
    OHOS::MMI::LogManager::GetInstance().PushFormat(OHOS::MMI::LL_INFO, __FILE__, __LINE__, MMI_FUNC_FMT fmt, MMI_FUNC_INFO, ##__VA_ARGS__);\
    OHOS::HiviewDFX::HiLog::Info(LABEL, MMI_FUNC_FMT fmt, MMI_FUNC_INFO, ##__VA_ARGS__);\
} while (0)

#define MMI_LOGW(fmt, ...) do {\
    OHOS::MMI::LogManager::GetInstance().PushFormat(OHOS::MMI::LL_WARN, __FILE__, __LINE__, MMI_FUNC_FMT fmt, MMI_FUNC_INFO, ##__VA_ARGS__);\
    OHOS::HiviewDFX::HiLog::Warn(LABEL, MMI_FUNC_FMT fmt, MMI_FUNC_INFO, ##__VA_ARGS__);\
} while (0)

#define MMI_LOGE(fmt, ...) do {\
    OHOS::MMI::LogManager::GetInstance().PushFormat(OHOS::MMI::LL_ERROR, __FILE__, __LINE__, MMI_FUNC_FMT fmt, MMI_FUNC_INFO, ##__VA_ARGS__);\
    OHOS::HiviewDFX::HiLog::Error(LABEL, MMI_FUNC_FMT fmt, MMI_FUNC_INFO, ##__VA_ARGS__);\
} while (0)

#define MMI_LOGA(fmt, ...) do {\
    OHOS::MMI::LogManager::GetInstance().PushFormat(OHOS::MMI::LL_ALARM, __FILE__, __LINE__, MMI_FUNC_FMT fmt, MMI_FUNC_INFO, ##__VA_ARGS__);\
    OHOS::HiviewDFX::HiLog::Error(LABEL, MMI_FUNC_FMT fmt, MMI_FUNC_INFO, ##__VA_ARGS__);\
} while (0)

#define MMI_LOGF(fmt, ...) do {\
    OHOS::MMI::LogManager::GetInstance().PushFormat(OHOS::MMI::LL_FATAL, __FILE__, __LINE__, MMI_FUNC_FMT fmt, MMI_FUNC_INFO, ##__VA_ARGS__);\
