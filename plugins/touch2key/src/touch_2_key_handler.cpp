...
PluginDispatchCmd Touch2KeyHandler::GetDispatchCmd()
{
    MMI_HILOGE("1111111111111111111111111111111");
    return DISCARD;
}

IInputEventConvertHandler::PluginDispatchEventType Touch2KeyHandler::GetDispatchEventType()
{
