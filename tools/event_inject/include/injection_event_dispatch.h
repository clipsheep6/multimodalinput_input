...
public:
    ...
    int32_t OnJson();
    int32_t OnException();
    int32_t OnTouchEvent();
    int32_t OnAisensorAll();
    int32_t OnAisensorEach();
    int32_t OnKnuckleAll();
    int32_t OnKnuckleEach();
    int32_t OnHelp();
    int32_t OnAisensorOne(uint32_t code, uint32_t value);
    int32_t OnKnuckleOne(uint32_t code, uint32_t value);
    ...
    int32_t GetSendEventType(std::string id);
    bool RegistInjectEvent(InjectFunctionMap& msg)
    {
        ...
        mapSendEventType_[msg.id] = msg.injectToHdi;
        return true;
    }
...
private:
    ...
    int32_t argvNum_ = 0;
    ParseFile parse_;
    MMITestAuxTool aisensor_;
    ManageInjectDevice manageInjectDevice_;
    InjectionTouchEvent touchEvent_;
...
private:
    static constexpr uint32_t HDI_ARGV_INDEX = 2;
    static constexpr uint32_t CMD_CODE_INDEX = 2;
    static constexpr uint32_t CMD_VALUE_INDEX = 3;
    static constexpr uint32_t CMD_TYPE_INDEX = 4;
    static constexpr uint32_t TOUCH_ARGV_INVALID = 3;
    static constexpr uint32_t TOUCH_FILE_INDEX = 1;
    static constexpr uint32_t DEVICE_PATH_INDEX = 1;
    static constexpr uint32_t COMMAND_PATH_INDEX = 2;
    static constexpr uint32_t DEVICE_ARGV_COUNTS = 3;
    static constexpr uint32_t DRIVE_ARGV_COUNTS = 3;
    static constexpr uint32_t HDI_EVENT_ARGV_COUNTS = 3;
    ...
    static constexpr uint32_t HDI_EVENT_COMMAND_INDEX = 2;
    static constexpr uint32_t AI_ALL_ARGV_INVALID = 2;
    static constexpr uint32_t AI_EACH_ARGV_INVALID = 3;
    static constexpr uint32_t HDI_ALL_ARGV_INVALID = 3;
    static constexpr uint32_t VIRTUAL_CMD_PARA_VALID_NUM = 5;
    static constexpr int32_t READ_CMD_EVENT_LEN = 6;
    ...
    static constexpr int32_t TEST_ON_LIST_CODE_INDEX = 0;
    static constexpr int32_t TEST_ON_LIST_VALUE_INDEX = 1;
    static constexpr int32_t TEST_EXCEPTION_CODE_INDEX = 0;
    static constexpr int32_t TEST_EXCEPTION_VALUE_INDEX = 1;
