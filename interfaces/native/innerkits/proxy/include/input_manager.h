...
public:
    ...
    /**
     * @brief Sets whether the mouse icon is visible.
     * @param visible Whether the mouse icon is visible. The value **true** indicates that the mouse icon is visible, and the value **false** indicates the opposite.
     * @return void
     * @since 9
     */
