...
enum class MmiMessageId : int32_t {
    ...
    INPUT_VIRTUAL_DEVICE_IDS,
    GET_ALL_NODE_DEVICE_INFO,
    INPUT_VIRTUAL_DEVICE,
    SHOW_MOUSE,
    HIDE_MOUSE,
    INPUT_MOUSE_LOCATION,
    INPUT_PREPARE_REMOTE,
    INPUT_UNPREPARE_REMOTE,
    INPUT_START_REMOTE,
    INPUT_STOP_REMOTE,
    SIMULATE_CROSS_LOCATION,
