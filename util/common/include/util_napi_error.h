...
enum NapiErrorCode : int32_t {
    ...
    POINTER_NO_PERMISSION_ERROR = 4000002,
...
const std::map<int32_t, NapiError> NAPI_ERRORS = {
    ...
    The {POINTER_WINDOW_ID_ERROR, {"4000001", "Invalid window ID"}},
    {POINTER_NO_PERMISSION_ERROR, {"4000002", "No permission to set the current window style"}},
