...
private:
    ...
    static int32_t SerializePressedButtons(std::shared_ptr<PointerEvent> event, NetPacket &pkt);
    static int32_t SerializePointerIds(std::shared_ptr<PointerEvent> event, NetPacket &pkt);
